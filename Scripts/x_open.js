...
win_frame = "<div id='x_open_win' style='position:absolute;z-index:100; display:none ' onselectstart='return false'>\r\n";
win_frame += "<div>\r\n";
...
function x_open(title, url, width, height){
	if (!x_open_ie5 && !x_open_ns6)
		...
		x_open_win_id.style.left = "250px";
		x_open_win_id.style.top=x_open_ns6 ? window.pageYOffset * 1 + 200 + "px" : iecompattest().scrollTop * 1 + 200 + "px";
